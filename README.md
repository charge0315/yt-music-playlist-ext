...
<img src="docs/screenshot-process.png" alt="処理中画面" width="400">
...
4. 処理中はリアルタイムで進行状況を確認
5. → お気に入りアーティストの新曲を網羅したプレイリストが完成！
...
4. アーティスト別の検索進行状況を監視
5. → 人気の代表曲を集めたベストヒットプレイリストが完成！

### 🔄 処理フロー
1. **設定確認** → ポップアップで設定内容を入力
2. **楽曲検索開始** → アーティスト別の楽曲検索を実行
3. **進行状況表示** → リアルタイムで検索状況を表示
4. **プレイリスト作成** → YouTube側でプレイリストを生成
5. **結果表示** → 完成したプレイリストと統計情報を表示
